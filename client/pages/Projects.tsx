  ...
  const projects = [
    {
      ...
      description:
        "Complete design system overhaul for a fintech startup, including component library, design tokens, and documentation.",
      image:
        "https://images.unsplash.com/photo-1551650975-87deedd944c3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1474&h=842&q=80",
    ...
    },
    {
      ...
      description:
        "End-to-end redesign of a collaboration platform used by over 100,000 designers worldwide.",
      image:
        "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1415&h=842&q=80",
    ...
    },
    {
      ...
      category: "Mobile App",
      description:
        "Native mobile app design for creative professionals to manage projects and collaborate on the go.",
      image:
        "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&h=842&q=80",
      tags: ["Mobile Design", "iOS", "Android"],
      results: [
        "200K+ downloads in 6 months",
    ...
    },
    {
      ...
      description:
        "Complete brand identity and digital presence for a growing technology consultancy.",
      image:
        "https://images.unsplash.com/photo-1558655146-d09347e92766?ixlib=rb-4.0.3&auto=format&fit=crop&w=1364&h=842&q=80",
    ...
    },
    {
      ...
      description:
        "Advanced dashboard interfaces for complex data visualization and analytics platform.",
      image:
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&h=842&q=80",
      tags: ["Data Visualization", "Dashboard", "Analytics"],
      results: [
        "60% faster data insights",
    ...
    },
    {
      ...
      category: "E-commerce",
      description:
        "Sustainable e-commerce platform design focused on environmental impact and user experience.",
      image:
        "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&h=842&q=80",
      ...
      <section className="px-4 sm:px-6 pt-8 sm:pt-16 pb-12 sm:pb-20 max-w-7xl mx-auto">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed">
            Explore our portfolio of successful design projects that have
                  ...
                  <div className="space-y-2 mb-6">
                    ...
                    <ul className="space-y-1">
                      {project.results.map((result, resultIndex) => (
                        <li
                          key={resultIndex}
                          className="text-brand-600 text-sm flex items-center"
                        >
                          <svg
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-brand-600 max-w-2xl mx-auto">
              Our work speaks for itself through measurable results and client
              success.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            {[
              ...
              },
              {
                ...
                desc: "Through our design work",
              },
              {
                number: "45%",
                label: "Avg. Performance Increase",
                desc: "In key metrics post-launch",
              },
            ].map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-brand-600 text-sm">{stat.desc}</div>
              </div>
            ))}
          </div>
        </div>
