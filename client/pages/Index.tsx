    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="w-full px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
        <div className="flex items-center">
          <h1 className="text-2xl font-bold text-foreground">designkit.</h1>
        </div>
        <Button 
          variant="default" 
      ...
      {/* Hero Section */}
      <main className="flex flex-col items-center justify-center px-6 pt-16 pb-8 max-w-7xl mx-auto">
        <div className="text-center max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-brand-600 mb-12 max-w-2xl mx-auto leading-relaxed">
            Streamline your workflow with tools built for modern design teams and creative professionals.
          </p>
          
          <Button 
            size="lg"
            className="bg-brand-800 hover:bg-brand-900 text-white rounded-lg px-8 py-4 text-lg font-medium transition-colors mb-16"
          >
            Get Started Today
          </Button>
        </div>
